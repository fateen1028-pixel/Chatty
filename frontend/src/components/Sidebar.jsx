...
const createFallbackAvatar = (username = 'User') => {
    return (
...
export default function Sidebar({
    ...
    const [userAvatar, setUserAvatar] =
        useState(fallbackAvatar);

    /*
     * Load the current authenticated user's uploaded avatar.
     *
    ...
    useEffect(() => {
        ...
        const loadProfileImage = async () => {
            try {
                const response =
                    await apiFetch('/api/profile/image');
        ...
        /*
         * Allows ProfileSettings.jsx to update the avatar
         * immediately without reloading the entire application.
         */
                    ...
                    await Promise.all(
                        data.map(async (chat) => {
                            ...
                            return {
                                ...
                                /*
                                 * Uses the real uploaded image if
                                 * recent-chats returns profileImageUrl.
                                 *
                                 * Otherwise, it uses DiceBear.
                                 */
                                avatar:
    ...
    const handleNewChat = async (e) => {
        ...
        try {
            const res = await apiFetch(
                `/receiver/search/${encodeURIComponent(
                    receiverUsername
                )}`
            );
            ...
            const newContact = {
                ...
                /*
                 * This works once your search endpoint returns:
                 *
                 * profileImageUrl
                 */
                avatar:
                ...
                <div className="flex items-center justify-between">
                    ...
                    >
                        <div className="relative">
                            <div className="absolute inset-0 bg-gradient-to-tr from-cyan-400 to-blue-500 rounded-full blur opacity-30 group-hover:opacity-60 transition-opacity duration-300" />
                                ...
                                <button
                                    ...
                                    className={`p-1.5 rounded-full transition-all duration-200 ${
                                        isMenuOpen
                                            ...
                                            : 'text-slate-400 hover:bg-white dark:hover:bg-slate-800 hover:text-cyan-600 dark:hover:text-cyan-400 hover:shadow-sm'
                                    }`}
                                    title="Menu"
                                >
                                    <MoreVertical
